...
subdirs_src+=$(filter-out Documentation, src_Pdfdata src_JHUGenMELA src_MelaAnalytics src_Alignment src_gconstants src_Configuration src_SimDataFormats src_HLTrigger src_RecoEgamma src_DQM src_GeneratorInterface src_PhysicsTools src_Validation src_KinZfitter src_CommonTools src_Geometry src_Fireworks src_KaMuCa src_UFHZZAnalysisRun2 src_CondCore src_SimG4CMS)
